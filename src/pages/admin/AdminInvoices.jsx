      ...
      <div style={s.inner}>
        ...
        {loading ? (
          ...
          <div style={s.empty}>
            ...
            <p>
              No invoices yet.{" "}
              <Link to="/admin/invoice/new" style={{ color: "#ea580c", fontWeight: 600 }}>
            ...
            <table style={s.table}>
              ...
              <tbody>
                {filtered.map((inv, index) => {
                  ...
                  return (
                    <tr key={inv.id} style={index % 2 === 0 ? s.trEven : s.trOdd}>
                      <td style={s.td}>
                      ...
                      <td style={s.td}>
                        <div style={s.rowActs}>
                          <button
                            style={s.viewBtn}
                            onClick={() => navigate(`/admin/invoice/view/${inv.id}`)}
                          >
                            👁 View / Print
                          </button>
                          ...
                          <button style={s.delBtn} onClick={() => setDelId(inv.id)}>
                            🗑
                          </button>
                        </div>
                      </td>
        ...
        <div style={s.overlay} onClick={() => setDelId(null)}>
          <div style={s.modal} onClick={(event) => event.stopPropagation()}>
            ...
            <div style={{ display: "flex", gap: 10 }}>
              <button style={s.cancelBtn} onClick={() => setDelId(null)}>
                Cancel
              </button>
